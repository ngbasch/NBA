...
## Get Historical Lines --------------------
    ...
    historical_date_df = pd.read_csv("/Users/nathanbasch/Documents_NB/Projects/Betting/Intermediate/games_to_pull_10_20.csv") 
    ...
    for year in range(2013, 2020):
        ...
        data.to_csv(r'/Users/nathanbasch/Documents_NB/Projects/Betting/Intermediate/Downloaded Books/'+str(year)+ '_SBR_NBA_Lines.csv', index=False)#, header = False)
